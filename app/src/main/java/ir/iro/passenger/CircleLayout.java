...
public class CircleLayout extends ViewGroup {
	...
	public CircleLayout(Context context, AttributeSet attrs) {
		...
		try {
			int dividerColor = a.getColor(R.styleable.CircleLayout_sliceDivider, getResources().getColor(R.color.colorPrimary));
			mInnerCircle = a.getDrawable(R.styleable.CircleLayout_innerCircle);
			
			if(mInnerCircle instanceof ColorDrawable) {
				int innerColor = a.getColor(R.styleable.CircleLayout_innerCircle,  getResources().getColor(R.color.colorPrimary));
